...
const handleProduct = ({ productIdToUpdate, handleAdd, handleUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (productIdToUpdate) {
      // If updating, call the handleUpdate function
      await handleUpdate(productIdToUpdate, product);
    } else {
      // If adding, call the handleAdd function
